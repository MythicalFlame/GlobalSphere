...
function customCommand(command, msg) {
    ...
    } else if (command.split(" ")[0] == "discord") {
        Commands.run(`tellraw "${msg.sender.name}" {"rawtext":[{"text":"Discord Link: https://discord.gg/d4hCeZA8"}]}`)
    } else {
